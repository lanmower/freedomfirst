...
cleos push action eosio.token create '[ "eosio","1500000010.0000 SYS" ]' -p eosio.token@active
cleos push action eosio.token issue '[ "eosio", "1500000010.0000 SYS", "memo" ]' -p eosio@active
...
cleos system voteproducer prods moonshine moonshine occultcorner koh
cleos system voteproducer prods occultcorner moonshine occultcorner koh 
cleos system voteproducer prods koh moonshine occultcorner koh
